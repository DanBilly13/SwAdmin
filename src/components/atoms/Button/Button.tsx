...
const iconPaddingClasses: Record<ButtonSize, string> = {
  small: 'pl-2 pr-3',
  medium: 'pl-3 pr-4',
  large: 'pl-4 pr-6',
};
...
const variantClasses: Record<ButtonVariant, string> = {
  primary: 'bg-fill-primary text-fill-on hover:bg-opacity-90 active:bg-opacity-100',
  secondary: 'bg-surface border border-border text-content hover:bg-bg active:bg-surface',
...
export const Button = forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(({
  ...
  const commonClasses = classNames(
    ...
    leadingIcon ? iconPaddingClasses[size] : paddingClasses[size],
    {
      'w-full': fullWidth,
