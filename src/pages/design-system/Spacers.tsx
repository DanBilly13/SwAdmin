...
import { Spacer, SectionCard, PageTitle } from "../../components/atoms";
        ...
        <>
          <MainContentHead
            breadcrumbs={[
              ...
              { label: "Spacers", href: "/design-system/spacers" },
            ]}
          ...
          <PageTitle
            title="Spacers"
            description="Flexible spacing components for creating consistent layout and alignment."
          />
        </>
      }
      content={
