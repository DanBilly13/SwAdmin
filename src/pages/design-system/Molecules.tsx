...
import { 
  MainContentHead} from "../../components/molecules";
    ...
    <DesignSystemContentContainerSlots
      header={
        <>
          ...
          <PageTitle
            title="Molecules"
            description="Composite components built from atomic elements for enhanced functionality."
          />
        </>
      }
      content={
              ...
              <div>
                ...
                <div className="max-w-sm">
                  <UserProfile
                    ...
                    name="Dwayne Johnson"
                    role="Actor"
                    avatarSrc={getAssetPath("avatars/TheRock.jpg")}
              ...
              <div>
                ...
                <div className="max-w-sm">
                  <TeamProfile
                    ...
                    name="IFK Stockholm"
                    division="Division 1"
                    badgeSrc={getAssetPath("team-badges/IFK-Stockholm.png")}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="max-w-sm">
                  <TeamProfile
                    ...
                    name="Umeå FC"
                    division="Division 2"
                    badgeSrc={getAssetPath("team-badges/UmeaFC.jpg")}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="max-w-sm">
                  <TeamProfile
                    ...
                    badgeSrc={getAssetPath("team-badges/DIF.png")}
                  />
                </div>
              </div>
            </div>
